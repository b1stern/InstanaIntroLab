...
<AnchorLinks>
  <AnchorLink>1-1: Explore kubernetes</AnchorLink>
  <AnchorLink>1-2: Explore the Infrastructure View</AnchorLink>
  <AnchorLink>1-3: Exploring an Application</AnchorLink>
  <AnchorLink>1-4: Unbounded Analytics</AnchorLink>
  <AnchorLink>1-5: Explore Logging</AnchorLink>
...
You will see a list of kubernetes clusters.   In this environment, there is an x86, Power, and zLinux kubernetes/OCP Cluster. Select the vader-qotd2 cluster to drill in for more details. 
  ![](images/qotd-cluster.png)
...
To continue to the next section of the lab, select select the **Diagnosing Problems** section in the left size navigation or select the icon below.
